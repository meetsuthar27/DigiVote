...
function LoginPage() {
  return (
    <div className="relative h-screen w-full bg-gray-50 interfont dark:bg-gray-900 overflow-hidden">
      <FlickeringGrid
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="relative w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          {/* Apply BorderBeam to the login container */}
          <BorderBeam size={200} duration={10} colorFrom="#ff6b6b" colorTo="#ffa502" />
